...
function countChecked() {
  ...
  var remaining = 10 - total ;
  if (remaining < 0 ) {remaining = remaining + " Only the first 10 URLS will be rendered!"};
  $("#remaining").html(remaining);
  return remaining;
}
$("input.urls").click(function(e) {
  countChecked();
  $(this).parents(".alert").toggleClass("alert-danger").toggleClass("alert-success");
});
